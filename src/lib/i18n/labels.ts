...
import { currentAcharyaBrand } from '../acharya-client';

const labels = {
  // App name
  appName: { bn: 'অর্জুন আচার্য', hi: 'अर्जुन आचार्य', en: 'Arjun Acharya' },
  ...
  tools: { bn: 'Tools', hi: 'Tools', en: 'Tools' },
  ...
  privacyNotice: {
    bn: 'তোমার প্রশ্ন ও উত্তর KarmYog Vatika দলের মানোন্নয়নের জন্য সংরক্ষণ করা হয়। কোনো ব্যক্তিগত তথ্য লিখো না।',
    hi: 'तुम्हारे सवाल और जवाब KarmYog Vatika टीम की समीक्षा के लिए संग्रहीत होते हैं। कोई निजी जानकारी मत लिखो।',
    en: 'Your questions and answers are stored for KarmYog Vatika team review. Please do not enter any personal information.',
  },
  ...
  // Quick actions for Ask tab — Vatika Sales & Service scenarios
  quickActions: {
    bn: [
...
export function t(key: keyof typeof labels, lang: Lang): string {
  if (key === 'appName') return currentAcharyaBrand().name;
