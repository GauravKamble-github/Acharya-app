    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-4 py-2.5">
          <Link href={acharyaRoute("/")} className="flex items-center gap-2.5 min-w-0" aria-label="Home">
            <Avatar size={32} useImage />
            <div className="leading-tight min-w-0">
              <div className="font-serif italic text-base text-ink truncate">{brand.shortName}</div>
              <div className="font-mono text-[8px] tracking-[0.18em] uppercase text-muted truncate">
                {currentLabel || brand.tagline}
              </div>
            </div>
          </Link>
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-line">
              <div className="flex items-center gap-2.5">
                ...
                <div className="leading-tight">
                  <div className="font-serif italic text-sm text-ink">{brand.name}</div>
            ...
            <div className="flex-1 overflow-y-auto px-3 py-4 space-y-5">
              ...
              <div className="space-y-4 border-t border-line pt-5 px-2">
                <section className="space-y-2">
                  <Tag tone="muted">Acharya</Tag>
                  <AcharyaSwitcher fullWidth />
                </section>
                <section className="space-y-2">
                ...
                <LogoutButton fullWidth onLoggedOut={() => setOpen(false)} />
              </div>
            </div>
          </div>
        </div>
