...
const PIN_KEY = 'arjun-gate-unlocked';
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-forest-deep p-6">
      ...
      >
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="font-serif italic text-3xl text-ink mt-1">Arjun Acharya</h1>
          <p className="text-xs text-muted mt-1">Sales &amp; Service · Internal</p>
        </div>
