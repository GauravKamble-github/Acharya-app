...
import {dbConfigured, dbForSlug, getCurrentAcharyaSlug, isMissingDbObject } from "@/lib/server/supabase";
...
export async function GET() {
  ...
  if (dbConfigured) {
    ...
    if (!error && data) {
      ...
      source = "supabase";
    } else if (error && !isMissingDbObject(error)) {
