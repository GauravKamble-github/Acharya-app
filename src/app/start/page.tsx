...
import { acharyaRoute, currentAcharyaBrand } from '@/lib/acharya-client';
...
export default function WelcomePage() {
  ...
  function enter(selectedLang: Lang) {
    ...
    router.push(acharyaRoute('/learn'));
  }
    ...
    <div className="min-h-screen bg-paper flex flex-col">
      ...
      <div className="bg-forest-deep text-cream px-6 pt-12 pb-14 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h1 className="font-serif italic text-4xl lg:text-5xl mt-5 leading-tight">{brand.name}</h1>
          <p className="font-mono text-[10px] tracking-[0.22em] uppercase text-gold mt-3">
            {brand.tagline} · Unified · v1.1
          </p>
          <p className="text-cream/70 text-sm mt-3 max-w-md">
            {brand.description} · Bengali, Hindi, English
          </p>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-4 lg:gap-6">
          ...
          <Card tone="cream" padding="lg" className="shadow-sm lg:col-span-2">
            <Tag tone="forest" filled className="mb-3">
              {lang === 'bn' ? 'অর্জুন কে' : lang === 'hi' ? 'अर्जुन कौन' : 'Who is Arjun'}
            </Tag>
            <p className="font-serif text-[15px] lg:text-[17px] leading-[1.65] text-ink">
              {lang === 'bn' ? (
                <>আমি <em>অর্জুন</em> — KarmYog Vatika-র বিক্রয় ও পরিষেবা দলের জন্য তোমার প্রশিক্ষক। তুমি যদি Vatika-র সেলস বা সার্ভিস দলে যোগ দিয়েছো — অথবা OmniDEL প্ল্যাটফর্মে — এই প্লেবুক তোমার প্রথম সপ্তাহের সঙ্গী।</>
              ) : lang === 'hi' ? (
                <>मैं <em>अर्जुन</em> — KarmYog Vatika की सेल्स और सर्विस टीम के लिए तुम्हारा ट्रेनर। अगर तुम Vatika की सेल्स या सर्विस टीम में जुड़े हो — या OmniDEL प्लेटफ़ॉर्म पर — यह प्लेबुक तुम्हारे पहले हफ़्ते का साथी है।</>
              ) : (
                <>I am <em>Arjun</em> — your trainer for the KarmYog Vatika Sales &amp; Service team. If you have joined the KarmYog Vatika Sales/Service team — or the broader OmniDEL platform — this playbook is your week-one companion.</>
              )}
            </p>
          </Card>
          ...
          <Card tone="paper" padding="lg" className="shadow-sm">
            ...
            <div className="space-y-2">
              ...
              <TabExplain icon="chat"
                ...
                desc={lang === 'bn' ? 'অর্জুনকে কথা বলো · MCQ পরীক্ষা · মাঠের প্রয়োগ' : lang === 'hi' ? 'अर्जुन से बातें · MCQ परीक्षा · मैदान अभ्यास' : 'Chat with Arjun · MCQ quiz · Field debrief'} />
          ...
          <Card tone="paper" padding="lg" className="shadow-sm">
            ...
            <ol className="space-y-2.5 border-l border-line pl-4">
              ...
              <DayStep n={3} task={lang === 'bn' ? 'M06 Vatika.AI → M09 কেস স্টাডি' : lang === 'hi' ? 'M06 Vatika.AI → M09 केस स्टडी' : 'M06 Vatika.AI → M09 Case Studies'} />
              ...
              <DayStep n={6} task={lang === 'bn' ? 'Ram-এর সেলস কলে উপস্থিত · একটি Vatika ভ্রমণ' : lang === 'hi' ? 'Ram की सेल्स कॉल · एक Vatika देखने जाओ' : "Sit in on a Ram sales call · Visit a live Vatika"} />
            ...
            <p className="text-[10px] text-muted text-center mt-4">
              {lang === 'bn' ? 'আটকে গেলে, Ask-এ গিয়ে অর্জুনকে জিজ্ঞেস করো — ২৪×৭।' : lang === 'hi' ? 'कहीं अटक जाओ तो Ask में अर्जुन से पूछो — 24×7।' : "If you're stuck anywhere, go to the Ask tab and ask Arjun — 24×7."}
            </p>
          </Card>
            ...
            <div className="mt-5 max-w-2xl mx-auto flex items-start gap-2 text-cream/80 text-[11.5px] leading-snug">
              ...
              <p>
                <span className="block mb-1">
                  {lang === 'bn'
                    ? 'তোমার প্রশ্ন ও উত্তর KarmYog Vatika দলের মানোন্নয়নের জন্য সংরক্ষণ করা হয়। কোনো ব্যক্তিগত তথ্য লিখো না।'
                    : lang === 'hi'
                    ? 'तुम्हारे सवाल और जवाब KarmYog Vatika टीम की समीक्षा के लिए संग्रहीत होते हैं। कोई निजी जानकारी मत लिखो।'
                    : 'Your questions and answers are stored for KarmYog Vatika team review. Please do not enter any personal information.'}
                </span>
              </p>
            </div>
          </Card>
