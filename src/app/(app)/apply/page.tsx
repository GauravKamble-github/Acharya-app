...
const prompts = {
  bn: {
    ...
    examples: [
      ...
      'আজ RD-তে walk-in ক্লায়েন্টকে Vatika Ankita দেখিয়েছি, ছবি তুলে AI render পাঠিয়েছি',
    ],
  },
  hi: {
    ...
    examples: [
      ...
      'आज RD में walk-in ग्राहक को Vatika Ankita दिखाया, फोटो से AI render बनाकर भेजा',
    ],
  },
  en: {
    ...
    finishNote: 'When you\'ve said everything, tap "Submit progress" — Arjun will give a score.',
    examples: [
      ...
      'Today I showed a walk-in client at RD the Vatika Ankita app, generated an AI render from their photo',
    ],
  },
};
...
export default function ApplyPage() {
  ...
  async function playArjunReply(text: string) {
