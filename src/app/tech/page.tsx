...
export const metadata = {
  title: 'Abhishek Acharya — Technical Architecture',
  description: 'System architecture, data pipeline, and infrastructure for the NSDC Vegetable Grower training platform',
};
      ...
      <header className="bg-forest text-white py-12 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-5">
            <Image src="/brand/abhishek.jpg" alt="Abhishek" width={72} height={72} className="rounded-full border-3 border-gold shadow-lg" />
            <div>
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Abhishek Acharya</h1>
          ...
          <p className="text-white/80 text-lg mt-6 max-w-3xl leading-relaxed">
            AI-powered training platform for NSDC-certified vegetable growers. 38 modules, trilingual (Bengali/Hindi/English),
        ...
        <Section title="Technology Stack">
          <div className="space-y-3">
            ...
            <StackCard
              ...
              detail="generateText() from @ai-sdk/anthropic. 252-line system prompt covering all 9 compulsory NOS + 6 electives. Abhishek persona: warm, patient, field-focused. No markdown output (responses convert to speech). Model-portable — swap provider in one line."
            />
            <StackCard
              layer="AI — Quiz"
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              ...
              <tbody className="divide-y divide-sage">
                ...
                <PipelineRow action="Ask Abhishek" fn="syncChatMessage()" table="acharya_chat_logs" data="User msg, AI response, response time (ms), lang" />
    ...
    └── ... (3 languages)`}</pre>
        ...
        <Section title="Learner Experience — 7 Screens">
          <div className="grid md:grid-cols-2 gap-4">
            <TabCard icon="🏠" name="Reception" desc="Welcome page with Abhishek intro, NSDC certification badge, feature preview, and language selection (big buttons: Bengali / Hindi / English). No cold drops." />
            ...
            <TabCard icon="💬" name="জিজ্ঞেস করো (Ask)" desc="AI chat with Abhishek persona. Voice input (Web Speech API) + voice output (TTS). Quick action buttons. Module-contextualized. Every message logged." />
...
│  │                                                          │   │
│  │   abhishek-acharya-app.vercel.app                       │   │
│  └────────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────────┘
  ...
  Secrets:     GitHub Secrets (4 keys encrypted)`}
        ...
        <Section title="Links">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            <LinkCard label="Live App" url="https://abhishek-acharya-app.vercel.app" />
            <LinkCard label="Admin Panel" url="https://abhishek-acharya-app.vercel.app/admin" />
            <LinkCard label="GitHub" url="https://github.com/omnidel-ai/abhishek-acharya-app" />
